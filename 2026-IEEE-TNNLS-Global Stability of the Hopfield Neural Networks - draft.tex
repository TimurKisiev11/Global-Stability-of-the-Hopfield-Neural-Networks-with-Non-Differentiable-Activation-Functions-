...
Section~\ref{sec:problem} states the HNN model in the Lur\'{e} form and assumptions~C1--C3. Section~\ref{sec:nonunique} presents a low-dimensional example showing that 
conditions \textbf{C1--C3} ensure global asymptotic stability of the unique equilibrium 
...
Section~\ref{sec:examples} contains some numerical illustrations, followed by Sections~\ref{sec:qubo-hnn}, \ref{sec:penalty-HNN} and \ref{sec:application_control} verify C1--C3 for four optimization embeddings.
